      ...
      <div className="max-w-md w-full">
        <div className="bg-white/80 backdrop-blur-sm shadow-2xl rounded-3xl p-4 sm:p-8 border border-white/20">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600 mt-2 text-base sm:text-lg">Join us and start tracking your activities</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-semibold py-3 px-4 rounded-xl hover:from-emerald-600 hover:to-teal-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-lg hover:shadow-xl"
            >
              {loading ? (
